...
class HourHandPainter extends CustomPainter {
  ...
  HourHandPainter(
      {required this.hours, required this.minutes, this.showHeartShape = false})
      : hourHandPaint = Paint() {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (showHeartShape) {
      ...
      path.quadraticBezierTo(
          radius * (-3.5) / 137.5,
          -radius + radius * 25.0 / 137.5,
          radius * (-15.0) / 137.5,
          -radius + radius / 4);
      path.quadraticBezierTo(radius * (-20.0) / 137.5, -radius + radius / 3,
          radius * (-7.5) / 137.5, -radius + radius / 3);
      path.lineTo(0.0, -radius + radius / 4);
      path.lineTo(7.5, -radius + radius / 3);
      path.quadraticBezierTo(radius * (20.0) / 137.5, -radius + radius / 3,
          radius * (15.0) / 137.5, -radius + radius / 4);
      path.quadraticBezierTo(
          radius * (3.5) / 137.5,
          -radius + radius * (25.0) / 137.5,
          0.0,
          -radius + radius * 15.0 / 137.5);
    }
